...
app.post('/create-group', (REQ, RES) => {
    ...
    Groups.create({
        ...
        admin: sequelize.fn('array_append',sequelize.col('admin'), parseInt(JSON.parse(REQ.body.admin))),
        numberOfParticipants:parseInt(JSON.parse(REQ.body.numberOfParticipants))
    }).then(u => {
        RES.sendStatus(200)
    })
})
